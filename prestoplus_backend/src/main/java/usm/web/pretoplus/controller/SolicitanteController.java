...
public class SolicitanteController {
	...
	public ModelAndView listar() {  //ALTERAR A PÁGINA ASSIM QUE RECEBER O LAYOUT
		ModelAndView resultado = new ModelAndView("presto/lista");
	...
	public ModelAndView inserir() {                  //ALTERAR A PÁGINA ASSIM QUE RECEBER O LAYOUT
		ModelAndView resultado = new ModelAndView("presto/cadastro_usuario");
	...
	public ModelAndView editar(@PathVariable Long id) {
		...
		ModelAndView resultado = new ModelAndView("presto/editar");
